    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addAnnouncement.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AnnouncementClass announcementClass = new AnnouncementClass(subject, body,"Issued on : "+today.toString());
                DatabaseReference NODE = FirebaseDatabase.getInstance().getReference().child("School").child("AnnouncementsRecord").child(announcementClass.getAnnouncementTitle().toLowerCase());
