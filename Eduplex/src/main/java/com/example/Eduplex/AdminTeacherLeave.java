...
public class AdminTeacherLeave extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addLeaveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(validate()) {
                    DatabaseReference CLASSTEACHER=FirebaseDatabase.getInstance().getReference().child("School").child("ClassTeacherRecord").child(tid.getText().toString());
                        ...
                        public void onDataChange(@NonNull  DataSnapshot snapshot) {
                            if(snapshot.exists())
                            {
                                LEAVENODE.push().setValue(new TeacherOnLeaveClass(tid.getText().toString().trim(),
                                        ...
                                        snapshot.child("teacherName").getValue().toString()
                            ...
                            {
                                Toast.makeText(AdminTeacherLeave.this, "Teacher does not exists", Toast.LENGTH_SHORT).show();
                            }
                        }

                        @Override
                        public void onCancelled(@NonNull  DatabaseError error) {
                            Toast.makeText(AdminTeacherLeave.this, "Can Not punch leave : "+error.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    });
                }
            }
    ...
    private boolean validate() {
        ...
        {
            Toast.makeText(this, "Please Enter Teacher's Leave Message to proceed", Toast.LENGTH_SHORT).show();
            return false;
        }
