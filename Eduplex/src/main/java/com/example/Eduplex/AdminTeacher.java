    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addTeacher.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    DatabaseReference CLASSTEACHER=FirebaseDatabase.getInstance().getReference().child("School").child("ClassTeacherRecord").child(stid);
                    ...
                    CLASSTEACHER.addListenerForSingleValueEvent(new ValueEventListener() {
                        @Override
                        public void onDataChange(@NonNull  DataSnapshot snapshot) {
                           if(!snapshot.exists()) {
                               //Toast.makeText(AdminTeacher.this, "present", Toast.LENGTH_SHORT).show();
                               NODE.setValue(teachersManager).addOnSuccessListener(new OnSuccessListener<Void>() {
                                   @Override
                                   public void onSuccess(Void unused) {
                                       CLASSTEACHER.setValue(new ClassTeacherAssociativityClass(stname,stclass+"-"+stSection)).addOnSuccessListener(new OnSuccessListener<Void>() {
                                           @Override
                                           public void onSuccess(Void unused) {
                               ...
                               Toast.makeText(AdminTeacher.this, "Teacher with id "+stid+" already exists", Toast.LENGTH_SHORT).show();
                        }
        ...
        removeTeacher.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    DatabaseReference CLASSTEACHER=FirebaseDatabase.getInstance().getReference().child("School").child("ClassTeacherRecord").child(tid.getText().toString().trim());
                    ...
                    NODE.addListenerForSingleValueEvent(new ValueEventListener() {
                       @Override
                       public void onDataChange(@NonNull  DataSnapshot snapshot) {
                           if(snapshot.hasChildren()&&snapshot.child("_id").getValue().toString().equals(tid.getText().toString()))
                           {
                               NODE.removeValue().addOnSuccessListener(new OnSuccessListener<Void>() {
                                   @Override
                                   public void onSuccess(Void unused) {
                                       CLASSTEACHER.removeValue().addOnSuccessListener(new OnSuccessListener<Void>() {
                                           @Override
                                           public void onSuccess(Void unused) {
                                           ...
                                           @Override
                                           public void onFailure(@NonNull  Exception e) {
                                               Toast.makeText(AdminTeacher.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                                           }
                                       });
                                        }
                               }).addOnFailureListener(new OnFailureListener() {
